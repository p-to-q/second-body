...
| id | kind | 是什么 | 进入条件 | 它问了什么 |
|---|---|---|---|---|
| `follow` | body | 基线：身体跟随你。原作的行为 | 永远可进入（兜底） | — |
| `echo` | body | 身体演的是你 **1.2 秒前**的动作 | tier≥2 且 ALIVE >25s | 那个身体是**现在**的我吗 |
| `resist` | body | 跟随，但**有重量**：快动作被阻尼，慢动作 1:1 | tier≥1 且 ALIVE >12s | 是它学我，还是我学它 |
| `facing` | body | 镜像被抵消：它不是你的反射，是一个**面对你的人** | tier≥1 且 ALIVE >18s | 那个身体是**我**吗 |
