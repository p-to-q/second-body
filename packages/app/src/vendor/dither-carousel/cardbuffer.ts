...
import { cardVertex } from "./shaders/card.ts";
import { bayerGLSL, revealGLSL } from "./shaders/dither.ts";
import type { CarouselConfig } from "./config.ts";
import type { Card } from "./scene.ts";
...
export function createCardBuffer(
